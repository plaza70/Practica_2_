...
Los resultados se muestran por pantalla y se guardan en un archivo de salida. Además, se utiliza un script en Bash para automatizar la ejecución del programa y gestionar el proceso.

En conclusión, la práctica aplica conceptos de lectura de archivos, uso de arrays, control de memoria y automatización mediante scripts.
